        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-3 max-w-3xl mx-auto">
              ...
              {/* Bilibili - 替换 LinkedIn */}
              <a 
                href="https://space.bilibili.com/2112644368" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="group bg-gradient-to-br from-pink-50 to-rose-50 p-6 rounded-2xl shadow-lg transform hover:scale-105 transition-all duration-300 border-2 border-pink-100"
              >
                <div className="flex flex-col items-center">
                  {/* 使用 B站图标 */}
                  <svg className="h-8 w-8 text-pink-500 group-hover:text-pink-600 transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="mt-3 text-gray-600 group-hover:text-gray-900 font-medium">Bilibili</span>
                  <span className="mt-1 text-sm text-gray-500">@turambar928</span>
                </div>
              </a>
            </div>
